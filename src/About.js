    ...
    return (
      <div className="about">
        ...
        <p>Cognitive science tells us that the best way to secure something in long-term memory is <b>retrieval practice</b>. 
          ...
          The target fact family is mixed with easier facts to avoid overwhelming students. Interleaving with a few other fact families avoids too much repetition and provides more varied practice. 
        ...
        <p>Nope. There are no shortcuts to fact fluency. 
          ...
          There is also an introductory version of Pulse at <a href="/intro">pulsemath.com/intro</a> that focuses on 2s, 5s, and 10s and is helpful for students who know very few multiplication facts. 
        ...
        <p>
          There's Pulse for integers <a href="/integers">here</a>, and an about page for the integers practice <a href="/about-int">here</a>. 
        </p>
        <hr></hr>
