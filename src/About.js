    ...
    return (
      <div className="about">
        ...
        <p1>The best way to respond when a student doesn't know a math fact is to give them 
          more practice with that fact and related facts. 
          Pulse gives students a short chunk of practice each day. 
          First, it figures out what fact families students could use help with, 
        ...
        <p>Nope. There are no shortcuts to fact fluency. 
          ...
          But there are never any guarantees, and Pulse only works as one part of classroom instruction.
        </p>
        ...
        <p>I prefer a tool that is simple to use. I can see what students are working on by looking at their screen. 
        ...
        <p>Practice is practice. I don't think it's helpful to pretend that practice is a game. 
