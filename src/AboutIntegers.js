    ...
    return (
      <div className="about">
        ...
        <p>The basic premise is similar to the other Pulse practice pages. 
          ...
          These are less frequent, but help to ensure there is still some interleaved practice and avoid overgeneralization. 
          Each problem type has a unique mix of problems designed to focus on that problem type while mixing with some easier questions and a few other problem types that we want students to discriminate between. 
        </p>
        <hr></hr>
        ...
        <p>
          ...
          That's what Pulse is designed for. If students don't have the foundation, Pulse won't be as effective. 
        </p>
        <hr></hr>
